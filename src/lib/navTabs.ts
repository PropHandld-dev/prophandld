...
import { HomeIcon, BuildingIcon, WrenchIcon, CalendarIcon, UserIcon, ClipboardListIcon, SettingsIcon, MessageCircleIcon } from '@/components/icons'
...
export const LANDLORD_TABS: TabItem[] = [
  ...
  { href: '/landlord/messages', label: 'Messages', icon: MessageCircleIcon },
...
export const RENTER_TABS: TabItem[] = [
  ...
  { href: '/renter/messages', label: 'Messages', icon: MessageCircleIcon },
...
export const CONTRACTOR_TABS: TabItem[] = [
  ...
  { href: '/contractor/messages', label: 'Messages', icon: MessageCircleIcon },
